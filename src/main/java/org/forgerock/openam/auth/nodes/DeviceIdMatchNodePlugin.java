 ...
 * @since AM 5.5.0
 */
public class DeviceIdMatchNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(DeviceIdMatchNodePlugin.currentVersion, 
				Collections.singletonList(DeviceIdMatchNode.class));
	}
	...
	public String getPluginVersion() {
		return DeviceIdMatchNodePlugin.currentVersion;
	}
}
