 ...
 * @since AM 5.5.0
 */
public class DeviceIdSaveNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(DeviceIdSaveNodePlugin.currentVersion, 
				Collections.singletonList(DeviceIdSaveNode.class));
	}
	...
	public String getPluginVersion() {
		return DeviceIdSaveNodePlugin.currentVersion;
	}
}
